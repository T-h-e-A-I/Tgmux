...
| 🔁 `/mode [name] [normal\|auto\|plan]` | set Claude Code mode directly — reads the status line and Shift+Tabs until it matches; bare `/mode` shows a button per mode with the current one marked |
